...
var svgs = {
  'cancel': React.createElement(__webpack_require__(27)["default"]),
  'cog': React.createElement(__webpack_require__(28)["default"]),
  'computer': React.createElement(__webpack_require__(29)["default"]),
  'cross': React.createElement(__webpack_require__(30)["default"]),
  'factory': React.createElement(__webpack_require__(31)["default"]),
  'fist': React.createElement(__webpack_require__(32)["default"]),
  'human': React.createElement(__webpack_require__(33)["default"]),
  minus: React.createElement(__webpack_require__(34)["default"]),
  'planet': React.createElement(__webpack_require__(35)["default"]),
  play: React.createElement(__webpack_require__(36)["default"]),
  plus: React.createElement(__webpack_require__(37)["default"]),
  remove: React.createElement(__webpack_require__(38)["default"]),
  user: React.createElement(__webpack_require__(39)["default"]),
  settings: React.createElement(__webpack_require__(40)["default"]),
  'ship': React.createElement(__webpack_require__(41)["default"]),
  'star': React.createElement(__webpack_require__(42)["default"]),
  'step-backward': React.createElement(__webpack_require__(43)["default"])
};
...
const Player = __webpack_require__(19);
const Cell = __webpack_require__(20);
const Move = __webpack_require__(21);
const Alert = __webpack_require__(22);
const AI = __webpack_require__(23);
const consts = __webpack_require__(1);
		...
		for (let i=0; i<moves.length; i++) {
			if (moves[i].getTurnArrival() <= turn) {
				...
				if (cellPlayer == movePlayer) {
					...
					if (cell.getArmy() + randomDefense + defenseAdvantage >= moves[i].getArmy() + attackAdvantage) {
...
Game.create = function (params) {
	for (let i=0; i<params.players.length; i++) {
		console.log(params.players[i].advantage);
...
const display = __webpack_require__(12);
...
const Main = __webpack_require__(18);
...
*/
var aa=__webpack_require__(0),m=__webpack_require__(7),q=__webpack_require__(16);function t(a){for(var b=a.message,c="https://reactjs.org/docs/error-decoder.html?invariant="+b,d=1;d<arguments.length;d++)c+="&args[]="+encodeURIComponent(arguments[d]);a.message="Minified React error #"+b+"; visit "+c+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ";return a}if(!aa)throw t(Error(227));var ba=null,ca={};
...
var SmallButton = __webpack_require__(6);

var Destination = __webpack_require__(44);

var Alert = __webpack_require__(45);

var Move = __webpack_require__(46);

var Planet = __webpack_require__(47);

var Statistics = __webpack_require__(48);
...
var PlayerIndicator = __webpack_require__(49);
...
var menuStateManager = __webpack_require__(10);
...
var NumberSelector = __webpack_require__(57);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(52).Buffer))
