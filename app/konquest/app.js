...
var svgs = {
  'cancel': React.createElement(__webpack_require__(42)["default"]),
  'check': React.createElement(__webpack_require__(43)["default"]),
  'cog': React.createElement(__webpack_require__(44)["default"]),
  'computer': React.createElement(__webpack_require__(45)["default"]),
  'cross': React.createElement(__webpack_require__(46)["default"]),
  'factory': React.createElement(__webpack_require__(47)["default"]),
  'fist': React.createElement(__webpack_require__(48)["default"]),
  'human': React.createElement(__webpack_require__(49)["default"]),
  'increase': React.createElement(__webpack_require__(50)["default"]),
  'minus': React.createElement(__webpack_require__(51)["default"]),
  'planet': React.createElement(__webpack_require__(52)["default"]),
  'play': React.createElement(__webpack_require__(53)["default"]),
  'plus': React.createElement(__webpack_require__(54)["default"]),
  'remove': React.createElement(__webpack_require__(55)["default"]),
  'user': React.createElement(__webpack_require__(56)["default"]),
  'settings': React.createElement(__webpack_require__(57)["default"]),
  'ship': React.createElement(__webpack_require__(58)["default"]),
  'star': React.createElement(__webpack_require__(59)["default"]),
  'step-backward': React.createElement(__webpack_require__(60)["default"])
};
...
function (_React$Component) {
  ...
  _createClass(Svg, [{
    ...
    value: function render() {
      if (svgs[this.props.icon]) {
        return svgs[this.props.icon];
      } else {
        console.error('Icon ' + this.props.icon + ' does not exist');
      }
    }
  }]);
...
exports.setMenuParams = function (params) {
	...
	if (params.options) {
		menuParams.options = params.options;
	}
...
const Cell = __webpack_require__(23);
const Move = __webpack_require__(24);
const Alert = __webpack_require__(25);
const AI = __webpack_require__(26);
const consts = __webpack_require__(2);
...
const Game = function (params) {
	...
	const endTurn = function () {
		...
		for (let i=0; i<moves.length; i++) {
			if (moves[i].getTurnArrival() <= turn) {
				...
				if (cellPlayer == movePlayer) {
					...
					// fight
					const randomDefense = parseInt(Math.random()*6 - 3);
					const defenseAdvantage = cell.getPlayer() && cell.getPlayer().getAdvantage() || 0;
					let attackAdvantage = moves[i].getPlayer() && moves[i].getPlayer().getAdvantage() || 0;

					const difference = cell.getArmy() + randomDefense + defenseAdvantage - moves[i].getArmy() - attackAdvantage;

					// defenser wins
					if (difference > -1) {
						cell.setArmy(Math.min(difference, cell.getArmy()));
						message = [
							'Planet ',
							{
								text : cell.getPlanetName() + ' ('+cell.getId()+')',
					...
					// attacker wins
						...
						cell.setProductivity(cell.getBaseProductivity());
						cell.setArmy(Math.min(-difference, moves[i].getArmy()));
						message = [
							'Planet ',
							{
								text : cell.getId(),
		...
		// increase productivity of planets
		if (options.cumulative) {
			const planets = self.getPlanets();
			for (let i=0; i<planets.length; i++) {
				if (planets[i].getPlayer()) {
					planets[i].setProductivity(planets[i].getProductivity() + 1);
				}
			}
		}
			...
			if (params.rows[i] && params.rows[i].length) {
				for (let j=0; j<params.rows[i].length; j++) {
					if (params.rows[i][j].hasPlanet) {
						params.rows[i][j].baseProductivity = parseInt(5 + Math.random() * 4);
						params.rows[i][j].productivity = params.rows[i][j].baseProductivity;
...
var _customEvent = __webpack_require__(12);
...
var _getEffect = __webpack_require__(34);

var _getEffect2 = _interopRequireDefault(_getEffect);

var _bodyMode = __webpack_require__(35);

var _bodyMode2 = _interopRequireDefault(_bodyMode);

var _trackRemoval = __webpack_require__(36);

var _trackRemoval2 = _interopRequireDefault(_trackRemoval);

var _getPosition = __webpack_require__(37);

var _getPosition2 = _interopRequireDefault(_getPosition);

var _getTipContent = __webpack_require__(38);

var _getTipContent2 = _interopRequireDefault(_getTipContent);

var _aria = __webpack_require__(39);

var _nodeListToArray = __webpack_require__(40);
...
exports.getInitialState = function () {
	...
	state.newGame = {
		...
		players : [],
		options : {
			cumulative : localStorageState.options && localStorageState.options.cumulative || false,
		},
	}
...
exports.changePlayer = function (idx, name, value) {
	if (name === 'color' && value === 'random') {
		...
		state.newGame.players[idx].advantage = parseInt(value);
	}
...
exports.changeOption = function(name, val) {
	state.newGame.options[name] = val;
	setState({
...
const display = __webpack_require__(15);
...
const Main = __webpack_require__(21);
...
var Menu = __webpack_require__(67);
...
function (_React$Component) {
  ...
  _createClass(Main, [{
    ...
    key: "render",
    value: function render() {
      return React.createElement(React.Fragment, null, this.state.page === 'game' ? React.createElement(Game, {
...
module.exports = function (params) {
	...
	const advantage = params.advantage || 0;
	...
	self.getProductivity = function() {
		const planets = game.getPlanets();
		let productivity = 0;
		for (let i=0; i<planets.length; i++) {
			if (planets[i].getPlayer() === self) {
				productivity += planets[i].getProductivity();
			}
		}
		return productivity;
	}
	...
	self.getShips = function() {
		...
		for (let i=0; i<planets.length; i++) {
			if (planets[i].getPlayer() === self) {
				ships += planets[i].getArmy();
			}
		}
		const moves = game.getMoves();
		for (let i=0; i<moves.length; i++) {
			if (moves[i].getPlayer() === self) {
				ships += moves[i].getArmy();
			}
		}
		return ships;
	}
...
module.exports = function (params) {
	...
	const baseProductivity = params.baseProductivity || 0;
	...
	self.getBaseProductivity = () => baseProductivity;
	...
	self.generateArmyNumber = function () {
		const total = army;
		const inc = Math.max(1, parseInt(total / 10));
		const c = inc * Math.ceil(total * 0.6 / inc);
		return c;
	}
...
var ReactTooltip = __webpack_require__(10);

var storage = __webpack_require__(3);

var Button = __webpack_require__(6);

var SmallButton = __webpack_require__(7);

var Destination = __webpack_require__(61);

var Alert = __webpack_require__(62);

var Move = __webpack_require__(63);

var Planet = __webpack_require__(64);

var Statistics = __webpack_require__(65);
    ...
    value: function render() {
      ...
      if (players.length > 1) {
        return React.createElement(React.Fragment, null, React.createElement(ReactTooltip, {
          ...
          className: "game-block"
        }, React.createElement("h2", null, "Players"), React.createElement(Statistics, {
          turn: self.state.game.getTurn(),
          players: players
        })));
      } else {
        ...
        return React.createElement(React.Fragment, null, React.createElement("div", {
          ...
          className: "game-block"
        }, React.createElement("h2", null, "Statistics"), React.createElement(Statistics, {
          turn: self.state.game.getTurn(),
          players: players
        })));
      }
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", _extends({
    ...
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 512 512",
    className: (styles["svg-inline--fa"] || "svg-inline--fa") + " " + (styles["fa-check"] || "fa-check") + " " + (styles["fa-w-16"] || "fa-w-16") + " " + (styles["fa-3x"] || "fa-3x")
  }, props), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("path", {
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", _extends({
    ...
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 512 512",
    className: (styles["svg-inline--fa"] || "svg-inline--fa") + " " + (styles["fa-cog"] || "fa-cog") + " " + (styles["fa-w-16"] || "fa-w-16") + " " + (styles["fa-9x"] || "fa-9x")
  }, props), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("path", {
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", _extends({
    ...
    clipRule: "evenodd",
    d: "M422.624 304.514V86.463c0-20.079-16.261-36.343-36.34-36.343H113.718c-20.079 0-36.343 16.264-36.343 36.343v218.051l-45.426 90.854v18.172c0 20.079 16.264 36.341 36.34 36.341H431.71c20.078 0 36.34-16.262 36.34-36.341v-18.172l-45.426-90.854zM142.793 95.549h214.413a19.935 19.935 0 0119.992 19.989v141.73a19.94 19.94 0 01-19.992 19.991H142.793a19.936 19.936 0 01-19.991-19.991v-141.73a19.931 19.931 0 0119.991-19.989zm52.694 263.477h109.026l9.086 36.341H186.401l9.086-36.341z",
    fill: "#010101",
    fillRule: "evenodd"
  }));
});
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", _extends({
    ...
    d: "M22.245 4.015a.808.808 0 010 1.139l-6.276 6.27a.81.81 0 000 1.14l6.273 6.272a.81.81 0 010 1.14l-2.285 2.277a.814.814 0 01-1.142 0l-6.271-6.271a.81.81 0 00-1.141 0l-6.276 6.267a.81.81 0 01-1.141 0l-2.282-2.28a.81.81 0 010-1.14l6.278-6.269a.81.81 0 000-1.14L1.709 5.147a.808.808 0 010-1.14l2.284-2.278a.813.813 0 011.142.001L11.405 8a.81.81 0 001.141.001l6.276-6.267a.812.812 0 011.141 0l2.282 2.281z"
  }));
});
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", _extends({
    ...
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 512 512",
    className: (styles["svg-inline--fa"] || "svg-inline--fa") + " " + (styles["fa-industry"] || "fa-industry") + " " + (styles["fa-w-16"] || "fa-w-16") + " " + (styles["fa-3x"] || "fa-3x")
  }, props), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("path", {
    fill: "currentColor",
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", _extends({
    ...
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 384 512",
    className: (styles["svg-inline--fa"] || "svg-inline--fa") + " " + (styles["fa-fist-raised"] || "fa-fist-raised") + " " + (styles["fa-w-12"] || "fa-w-12") + " " + (styles["fa-3x"] || "fa-3x")
  }, props), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("path", {
    fill: "currentColor",
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", _extends({
    ...
    clipRule: "evenodd",
    d: "M22 20.998h-1s-1 0-1-1V17.5a.5.5 0 10-1 0l-.008 4.295c0 .609-2.01 2.205-6.492 2.205s-6.492-1.596-6.492-2.205L6 17.5a.5.5 0 10-1 0v2.498c0 1-1 1-1 1H3s-1 0-1-1V15.75c0-2.922 2.892-5.401 6.93-6.341 0 0 1.234 1.107 3.57 1.107s3.57-1.107 3.57-1.107c4.038.94 6.93 3.419 6.93 6.341v4.248c0 1-1 1-1 1zM12.477 9a4.5 4.5 0 110-9 4.5 4.5 0 010 9z",
    fillRule: "evenodd"
  }));
});
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", _extends({
    ...
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 512 512",
    className: (styles["svg-inline--fa"] || "svg-inline--fa") + " " + (styles["fa-chart-line"] || "fa-chart-line") + " " + (styles["fa-w-16"] || "fa-w-16") + " " + (styles["fa-3x"] || "fa-3x")
  }, props), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("path", {
    fill: "currentColor",
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", _extends({
    ...
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 496 512",
    className: (styles["svg-inline--fa"] || "svg-inline--fa") + " " + (styles["fa-globe-africa"] || "fa-globe-africa") + " " + (styles["fa-w-16"] || "fa-w-16") + " " + (styles["fa-3x"] || "fa-3x")
  }, props), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("path", {
    fill: "currentColor",
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", _extends({
    ...
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 512 512",
    className: (styles["svg-inline--fa"] || "svg-inline--fa") + " " + (styles["fa-play-circle"] || "fa-play-circle") + " " + (styles["fa-w-16"] || "fa-w-16") + " " + (styles["fa-3x"] || "fa-3x")
  }, props), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("path", {
    fill: "currentColor",
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", _extends({
    ...
    clipRule: "evenodd",
    d: "M22.5 14H14v8.5a.5.5 0 01-.5.5h-4a.5.5 0 01-.5-.5V14H.5a.5.5 0 01-.5-.5v-4A.5.5 0 01.5 9H9V.5a.5.5 0 01.5-.5h4a.5.5 0 01.5.5V9h8.5a.5.5 0 01.5.5v4a.5.5 0 01-.5.5z",
    fillRule: "evenodd"
  }));
});
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", _extends({
    ...
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 512 512",
    className: (styles["svg-inline--fa"] || "svg-inline--fa") + " " + (styles["fa-trash-alt"] || "fa-trash-alt") + " " + (styles["fa-w-14"] || "fa-w-14") + " " + (styles["fa-3x"] || "fa-3x")
  }, props), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("path", {
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", _extends({
    ...
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 512 512",
    className: (styles["svg-inline--fa"] || "svg-inline--fa") + " " + (styles["fa-user"] || "fa-user") + " " + (styles["fa-w-14"] || "fa-w-14") + " " + (styles["fa-9x"] || "fa-9x")
  }, props), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("path", {
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", _extends({
    ...
    clipRule: "evenodd",
    d: "M21.521 10.146c-.41-.059-.846-.428-.973-.82l-.609-1.481c-.191-.365-.146-.935.1-1.264l.99-1.318c.246-.33.227-.854-.047-1.162l-1.084-1.086a.967.967 0 00-1.164-.045l-1.316.988c-.33.248-.898.293-1.264.101l-1.48-.609c-.395-.126-.764-.562-.82-.971L13.62.85c-.057-.409-.441-.778-.85-.822 0 0-.255-.026-.77-.026-.514 0-.769.026-.769.026-.41.044-.794.413-.852.822l-.233 1.629c-.058.409-.427.845-.82.971l-1.48.609c-.366.191-.934.147-1.264-.101l-1.318-.989a.964.964 0 00-1.163.045L3.017 4.1a.964.964 0 00-.046 1.162l.988 1.318c.249.33.293.899.102 1.264L3.45 9.326c-.125.393-.562.762-.971.82l-1.629.231a1.015 1.015 0 00-.82.853s-.027.255-.027.77.027.77.027.77c.043.411.412.793.82.852l1.629.232c.408.059.846.428.971.82l.611 1.48c.191.365.146.936-.102 1.264l-.988 1.318c-.248.33-.308.779-.132.994.175.217.677.752.678.754l.375.344c.204.188 1.042.449 1.372.203l1.317-.99c.33-.246.898-.293 1.264-.1l1.48.609c.394.125.763.562.82.971l.233 1.629c.058.408.441.779.852.822 0 0 .255.027.769.027.515 0 .77-.027.77-.027.409-.043.793-.414.85-.822l.234-1.629c.057-.408.426-.846.82-.971l1.48-.611c.365-.191.934-.146 1.264.102l1.318.99c.332.246.854.227 1.164-.047l1.082-1.084a.968.968 0 00.047-1.164l-.99-1.318c-.246-.328-.291-.898-.1-1.264l.609-1.48c.127-.393.562-.762.973-.82l1.627-.232c.41-.059.779-.441.822-.852 0 0 .027-.255.027-.77s-.027-.77-.027-.77c-.043-.41-.412-.794-.822-.853l-1.626-.231zM12 15a3 3 0 110-6 3 3 0 010 6z",
    fillRule: "evenodd"
  }));
});
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", _extends({
    ...
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 512 512",
    className: (styles["svg-inline--fa"] || "svg-inline--fa") + " " + (styles["fa-rocket"] || "fa-rocket") + " " + (styles["fa-w-16"] || "fa-w-16") + " " + (styles["fa-3x"] || "fa-3x")
  }, props), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("path", {
    fill: "currentColor",
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", _extends({
    ...
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 576 512",
    className: (styles["svg-inline--fa"] || "svg-inline--fa") + " " + (styles["fa-star"] || "fa-star") + " " + (styles["fa-w-18"] || "fa-w-18") + " " + (styles["fa-3x"] || "fa-3x")
  }, props), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("path", {
    fill: "currentColor",
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", _extends({
    ...
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 448 512",
    className: (styles["svg-inline--fa"] || "svg-inline--fa") + " " + (styles["fa-step-backward"] || "fa-step-backward") + " " + (styles["fa-w-14"] || "fa-w-14") + " " + (styles["fa-3x"] || "fa-3x")
  }, props), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("path", {
    fill: "currentColor",
...
module.exports = function (elt) {
  var destination = elt.getDestination();
  var color = destination && destination.getPlayer() && destination.getPlayer().getColor();
  return React.createElement("div", {
    className: "move"
  }, React.createElement("span", null, "From "), React.createElement("strong", null, elt.getOrigin().getPlanetName(), " (", elt.getOrigin().getId(), ")"), React.createElement("span", null, " on turn ", elt.getTurnDeparture(), " to "), React.createElement("strong", {
    className: color ? 'text-color color-' + color : null
  }, destination.getPlanetName(), " (", destination.getId(), ")"), React.createElement("span", null, " : ", elt.getArmy(), " ships"));
};
  ...
  _createClass(Planet, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        "data-tip": cell.getPlanetName() + '<br>' + 'Productivity ' + cell.getProductivity()
...
var PlayerIndicator = __webpack_require__(66);
...
function (_React$Component) {
  ...
  _createClass(Statistics, [{
    ...
    key: "render",
    value: function render() {
      return this.props.players.map(function (elt) {
        var stats = {
          planets: elt.getPlanets(),
          productivity: elt.getProductivity(),
          ships: elt.getShips(),
          advantage: elt.getAdvantage()
        };
        stats.score = stats.planets + stats.productivity + stats.ships;
        return React.createElement("div", {
          key: elt.getId(),
          className: "statistics"
        }, React.createElement(PlayerIndicator, {
          player: elt
        }), React.createElement("div", {
          className: "statistics-element",
          title: "Advantage",
          "data-tip": "Advantage " + stats.advantage
        }, stats.advantage, React.createElement(Svg, {
          icon: "fist"
        })), React.createElement("div", {
          className: "statistics-element",
          title: "Planets",
          "data-tip": stats.planets + " planets"
        }, stats.planets, React.createElement(Svg, {
          icon: "planet"
        })), React.createElement("div", {
          className: "statistics-element",
          title: "Productivity",
          "data-tip": "Productivity " + stats.productivity
        }, stats.productivity, React.createElement(Svg, {
          icon: "factory"
        })), React.createElement("div", {
          className: "statistics-element",
          title: "Ships",
          "data-tip": stats.ships + " ships"
        }, stats.ships, React.createElement(Svg, {
          icon: "ship"
        })), React.createElement("div", {
          className: "statistics-element",
          title: "Score",
          "data-tip": "Score " + stats.score
        }, stats.score, React.createElement(Svg, {
          icon: "star"
        })));
      });
    }
...
module.exports = function (props) {
  return React.createElement("div", {
    ...
    "data-tip": props.player.getName()
  }, React.createElement(Svg, {
    icon: props.player.getType() === 'human' ? 'user' : 'cog'
  }));
};
...
var menuStateManager = __webpack_require__(13);
...
var Checkbox = __webpack_require__(74);

var NumberSelector = __webpack_require__(76);
...
function (_React$Component) {
  ...
  function MenuPage() {
    ...
    menuStateManager.setSetState(_this.setState.bind(_assertThisInitialized(_this)));
  ...
  _createClass(MenuPage, [{
    ...
    key: "handleCheckBox",
    value: function handleCheckBox(target) {
      menuStateManager.changeOption(target.name, !target.value);
    }
  }, {
    key: "handleKeyDown",
    value: function handleKeyDown(event) {
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        return React.createElement("div", null, React.createElement("div", {
          ...
          icon: player.type === 'human' ? 'user' : 'cog'
          ...
          value: "computer"
        }, "Computer")), React.createElement("select", {
          name: "advantage",
          value: player.advantage,
          onChange: self.handleSelect.bind(self, idx)
        }, React.createElement("option", {
          value: "-1"
          ...
          value: "2"
        }, "2")), React.createElement(SmallButton, {
          glyph: "remove",
        ...
        className: "game-block"
      }, React.createElement("h2", null, "Options"), React.createElement(Checkbox, {
        onClick: self.handleCheckBox.bind(self),
        label: "Cumulative production",
        name: "cumulative",
        value: self.state.newGame.options.cumulative
      })), React.createElement("div", {
        className: "game-block"
        ...
        return React.createElement("tr", null, React.createElement("td", null, game.id), React.createElement("td", null, game.name), React.createElement("td", null, game.turn), React.createElement("td", null, game.options && game.options.cumulative && React.createElement("div", {
          className: "indicator",
          "data-tip": "Cumulative production"
        }, React.createElement(Svg, {
          icon: "increase"
        }))), React.createElement("td", null, React.createElement(SmallButton, {
          glyph: "play",
...
function (_React$Component) {
  ...
  _createClass(Checkbox, [{
    ...
    value: function render() {
      return React.createElement("div", {
        className: classNames('checkbox', this.props.className, this.props.value ? 'green' : 'red'),
        onClick: this.onClick.bind(this)
      }, React.createElement(Svg, {
        icon: this.props.value ? 'check' : 'cross'
      }), React.createElement("span", {
